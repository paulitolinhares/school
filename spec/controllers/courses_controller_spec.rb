...
RSpec.describe CoursesController, type: :controller do
  ...
  # Course. As you add validations to Cour, be sure to
  ...
  let(:invalid_attributes) {
    attributes_for(:course_empty_name)
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested course" do
        ...
        course.reload
        expect(course.name).to eq(attributes_for(:course2)[:name])
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the coursees list" do
      course = Course.create! valid_attributes
      delete :destroy, {:id => course.to_param}, valid_session
